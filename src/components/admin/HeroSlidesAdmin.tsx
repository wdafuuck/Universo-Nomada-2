            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="Ej: Atacama atardecer"
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-white/50 text-sm mt-1">
            {slides.length} fotos · Rotan en la portada de la web
          </p>
        </div>
        <Button
          onClick={() => { setEditing({ imageUrl: "", label: "", active: true, sortOrder: slides.length }); setIsNew(true); }}
          ...
          >
            ...
            <CardContent className="p-4 flex items-center justify-between gap-2">
              <div className="min-w-0">
                ...
                <p className="text-white/40 text-xs">Orden {slide.sortOrder}</p>
              </div>
